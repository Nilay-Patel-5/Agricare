...
<head>
    <meta charset="UTF-8">
    <title>Admin - AI Analytics | AgriCare</title>
...
<body class="flex h-screen overflow-hidden text-gray-800">
    ...
    <aside class="w-72 bg-gray-900 border-r border-gray-800 flex flex-col hidden lg:flex text-gray-300">
        ...
        <nav class="flex-1 overflow-y-auto py-6">
            ...
            <a href="admin_analytics.php" class="sidebar-link active flex items-center gap-4 px-6 py-3 border-transparent" style="background-color: #064e3b; color: #34d399; border-right: 4px solid #10b981;">
        ...
        <div class="flex-1 overflow-y-auto px-6 lg:px-10 py-8">
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <h2 class="text-3xl font-black text-gray-900">AI Analytics Engine</h2>
                </div>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden min-h-[400px] flex items-center justify-center flex-col">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Algorithm Diagnostics Placeholder</h3>
                <p class="text-gray-500 max-w-md text-center">Track and monitor server load caused by AI vision processing. Check classification accuracy and system performance.</p>
            </div>
        </div>
    </main>
</body>
