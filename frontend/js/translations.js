const translations = {
    "en": {
        ...
        "Insurance coverage and financial support to the farmers in the event of failure of any of the notified crops.": "Insurance coverage and financial support to the farmers in the event of failure of any of the notified crops.",
        "Stabilizing income of farmers, ensuring flow of credit to the agriculture sector.": "Stabilizing income of farmers, ensuring flow of credit to the agriculture sector.",
        "Kisan Credit Card (KCC) Scheme": "Kisan Credit Card (KCC) Scheme",
        "Provides timely credit to farmers for their cultivation and other needs such as purchase of inputs, etc.": "Provides timely credit to farmers for their cultivation and other needs such as purchase of inputs, etc.",
        "Simplified credit delivery, low interest rates, flexible repayment options.": "Simplified credit delivery, low interest rates, flexible repayment options."
    },
    "gu": {
        ...
        "subsidy_hero_title": "તમારા માટે <span class=\"text-emerald-600\">સરકારી સબસિડી</span>",
        ...
        "live_status": "ચાલુ",
        "Soil Health Card Scheme": "સોઈલ હેલ્થ કાર્ડ યોજના",
        "Issues Soil Health Cards to farmers with crop-wise recommendations for nutrients.": "ખેડૂતોને પાક મુજબ પોષક તત્વોની ભલામણો સાથે સોઈલ હેલ્થ કાર્ડ આપવામાં આવે છે.",
        "Free soil testing, personalized fertilizer recommendations, higher yields.": "નિ:શુલ્ક જમીન પરીક્ષણ, પર્સનલાઇઝ્ડ ખાતરની ભલામણો, વધુ ઉપજ.",
        "Gujarat Agriculture Subsidy Scheme (iKhedut)": "ગુજરાત આઈખેડૂત સહાય",
        "Gujarat state scheme for agricultural inputs, mechanization, and horticulture development.": "ખેત સાધનો, બાગાયત ઇનપુટ્સ અને સિંચાઈ ઘટકો માટે રાજ્ય-સ્તરની સહાય.",
        "Subsidies on seeds, fertilizers, drip irrigation, farm machinery (25-75%).": "બિયારણ, ખાતર, ટપક સિંચાઈ, ખેતીની મશીનરી (25-75%) પર સબસિડી.",
        ...
        "Subsidy on drip/sprinkler irrigation systems. 45-55% cost coverage.": "ટપક/ફુવારા પિયત પદ્ધતિ પર સબસિડી. 45-55% ખર્ચ કવરેજ.",
        ...
        "Free/subsidized seeds, fertilizers, and micronutrients. Training support.": "નિ:શુલ્ક/સબસિડીવાળા બિયારણ, ખાતર અને સૂક્ષ્મ પોષકતત્વો. તાલીમ સહાય.",
        ...
        "40-50% subsidy on farm equipment purchase. CHC setup assistance.": "ખેતીના સાધનોની ખરીદી પર 40-50% સબસિડી. CHC સેટઅપમાં મદદ.",
        "cat_financial": "નાણાકીય સહાય",
        "cat_insurance": "વીમો",
        "Pradhan Mantri Fasal Bima Yojana (PMFBY)": "પ્રધાનમંત્રી ફસલ બીમા યોજના (PMFBY)",
        "Insurance coverage and financial support to the farmers in the event of failure of any of the notified crops.": "નોટિફાઇડ પાકોમાંથી કોઈપણ નિષ્ફળ જવાની સ્થિતિમાં ખેડૂતોને વીમો અને નાણાકીય સહાય.",
        "Stabilizing income of farmers, ensuring flow of credit to the agriculture sector.": "ખેડૂતોની આવક સ્થિર કરવી, કૃષિ ક્ષેત્રમાં ધિરાણનો પ્રવાહ સુનિશ્ચિત કરવો.",
        "Kisan Credit Card (KCC) Scheme": "કિસાન ક્રેડિટ કાર્ડ (KCC) યોજના",
        "Provides timely credit to farmers for their cultivation and other needs such as purchase of inputs, etc.": "ખેડૂતોને તેમની ખેતી અને અન્ય જરૂરિયાતો જેવી કે ઇનપુટ્સની ખરીદી વગેરે માટે સમયસર ધિરાણ પૂરું પાડે છે.",
        "Simplified credit delivery, low interest rates, flexible repayment options.": "સરળ ધિરાણ વિતરણ, ઓછા વ્યાજ દર, લવચીક ચુકવણી વિકલ્પો."
    },
    "hi": {
        ...
        "Insurance coverage and financial support to the farmers in the event of failure of any of the notified crops.": "अधिसूचित फसलों में से किसी के विफल होने की स्थिति में किसानों को बीमा कवरेज और वित्तीय सहायता।",
        "Stabilizing income of farmers, ensuring flow of credit to the agriculture sector.": "किसानों की आय को स्थिर करना, कृषि क्षेत्र में ऋण का प्रवाह सुनिश्चित करना।",
        "Kisan Credit Card (KCC) Scheme": "किसान क्रेडिट कार्ड (KCC) योजना",
        "Provides timely credit to farmers for their cultivation and other needs such as purchase of inputs, etc.": "किसानों को उनकी खेती और अन्य जरूरतों जैसे इनपुट की खरीद आदि के लिए समय पर ऋण प्रदान करता है।",
        "Simplified credit delivery, low interest rates, flexible repayment options.": "सरलीकृत ऋण वितरण, कम ब्याज दरें, लचीले पुनर्भुगतान विकल्प।"
    }
};
